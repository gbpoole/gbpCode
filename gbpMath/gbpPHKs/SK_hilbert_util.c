/* $Id: hilbert_util.c,v 1.6 2008/06/18 06:40:19 knolli Exp $ */
...
extern hikey_t hilbert_util_prolongMin(unsigned int trgt_level, unsigned int src_level, hikey_t hikey) {
    hikey_t rtrn;
...
extern hikey_t hilbert_util_prolongMax(unsigned int trgt_level, unsigned int src_level, hikey_t hikey) {
    hikey_t  rtrn;
