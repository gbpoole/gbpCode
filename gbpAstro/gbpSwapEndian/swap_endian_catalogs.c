...
void swap_endian_catalogs_properties_local(const char *filename_in_root,
...
void swap_endian_catalogs_properties_local(const char *filename_in_root,
    ...
    sprintf(filename_in,
            "%s/%s_%03d.catalog_%sgroups_properties/%s_%03d.catalog_%sgroups_properties.%d",
            filename_in_root,
            filename_halo_type,
            snap_number,
            prefix,
...
void swap_endian_catalogs_profiles_local(const char *filename_in_root,
                                         const char *filename_out_root,
                                         const char *filename_halo_type,
                                         const char *prefix,
                                         int         snap_number,
...
void swap_endian_catalogs_profiles_local(const char *filename_in_root,
    ...
    char filename_out[MAX_FILENAME_LENGTH];
    sprintf(filename_in,
            "%s/%s_%03d.catalog_%sgroups_profiles/%s_%03d.catalog_%sgroups_profiles.%d",
            filename_in_root,
            filename_halo_type,
            snap_number,
            prefix,
...
void swap_endian_catalogs_SO_local(const char *filename_in_root,
                                   const char *filename_out_root,
                                   const char *filename_halo_type,
                                   const char *prefix,
                                   int         snap_number,
...
void swap_endian_catalogs_SO_local(const char *filename_in_root,
    ...
    char filename_out[MAX_FILENAME_LENGTH];
    sprintf(filename_in,
            "%s/%s_%03d.catalog_%sgroups_SO/%s_%03d.catalog_%sgroups_SO.%d",
            filename_in_root,
            filename_halo_type,
            snap_number,
            prefix,
