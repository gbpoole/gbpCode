...
double R_Delta_z(double M_Delta, double Delta, double redshift, cosmo_info *cosmo);
...
double dlna_dtau(double a, cosmo_info *cosmo);
double rho_crit_z(double redshift, cosmo_info *cosmo);
double rho_crit_z_strip(double redshift, double h_Hubble, double Omega_M, double Omega_Lambda);
