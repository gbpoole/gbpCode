...
double R_vir_NFW(double M_vir, double z, int mode, cosmo_info **cosmo);
double c_vir_NFW(double M_vir, double z, int mode, cosmo_info **cosmo);
...
double M_r_NFW(double r, double M_vir, double z, int mode, cosmo_info **cosmo);
double V_circ_NFW(double r, double M_vir, double z, int mode, cosmo_info **cosmo);
double V_circ_vir_NFW(double M_vir, double z, int mode, cosmo_info **cosmo);
double V_max_NFW(double M_vir, double z, int mode, cosmo_info **cosmo);
...
double R_V_max_NFW(double M_vir, double z, int mode, cosmo_info **cosmo);
double Delta_half_V_max_NFW(double M_vir, double z, int mode, cosmo_info **cosmo);
double Delta_half_V_max_NFW(double M_vir, double z, int mode, cosmo_info **cosmo);
