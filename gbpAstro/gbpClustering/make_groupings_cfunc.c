        ...
        for(i_run = 0; i_run < 4; i_run++) {
            ...
            switch(i_run) {
                case 0:
                    ...
                    read_groupings(
                        filename_in_root, i_grouping, &plist, READ_GROUPING_PHK, cfunc.r_max, cfunc.box_size, cfunc.n_bits_PHK, cfunc.PHK_width);
                    break;
                case 1:
                    ...
                    read_groupings(filename_in_root,
                                   i_grouping,
                                   &plist,
                                   READ_GROUPING_PHK | READ_GROUPING_ADD_VX,
                                   cfunc.r_max,
                                   cfunc.box_size,
                                   cfunc.n_bits_PHK,
                                   cfunc.PHK_width,
                ...
                case 2:
                    ...
                    read_groupings(filename_in_root,
                                   i_grouping,
                                   &plist,
                                   READ_GROUPING_PHK | READ_GROUPING_ADD_VY,
                                   cfunc.r_max,
                                   cfunc.box_size,
                                   cfunc.n_bits_PHK,
                                   cfunc.PHK_width,
                ...
                case 3:
                    ...
                    read_groupings(filename_in_root,
                                   i_grouping,
                                   &plist,
                                   READ_GROUPING_PHK | READ_GROUPING_ADD_VZ,
                                   cfunc.r_max,
                                   cfunc.box_size,
                                   cfunc.n_bits_PHK,
                                   cfunc.PHK_width,
