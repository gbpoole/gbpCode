...
treenode_hist_props_info treenode_hist_props = {{"z", "M", "M_peak", "N", "N_peak", "M0", "xi"},
                                                {"$z$",
                                                 "$M_{\\rm{vir}}[h^{-1} M_\\odot]$",
                                                 "$M_{\\rm{peak}}[h^{-1} M_\\odot]$",
                                                 "$\\rm{n_p}$",
                                                 "$\\rm{n_{peak}}$",
                                                 "$M_{\\rm{0}}[h^{-1} M_\\odot]$",
                                                 "$\\xi$"},
                                                {"$\\log_{10}{z}$",
                                                 "$\\log_{10}{\\rm{M}_{\\rm{vir}}[h^{-1} \\rm{M}_\\odot]}$",
                                                 "$\\log_{10}{\\rm{M}_{\\rm{peak}}[h^{-1} \\rm{M}_\\odot]}$",
                                                 "$\\log_{10}{\\rm{n_p}}$",
                                                 "$\\log_{10}{\\rm{n_{peak}}}$",
                                                 "$\\log_{10}{\\rm{M}_{\\rm{0}}[h^{-1} \\rm{M}_\\odot]}$",
                                                 "$\\log_{10}{\\xi}$"},
                                                {1, 3, 3, 3, 3, 3, 3},
...
void                  init_treenode_list(const char *catalog_name, int n_list_alloc, treenode_list_info **list);
void                  reset_treenode_list(treenode_list_info *list);
void                  init_treenode_info_data(treenode_list_info *list, void **rval, SID_Datatype data_type, const char *name, ...);
...
int                   find_treenode_formation(tree_info *trees, tree_node_info *halo, double f, tree_node_info **fraction_of_peak_mass);
...
int find_treenode_accretion(tree_info *trees, tree_node_info *halo, tree_node_info **first_satellite, tree_node_info **join_current_group);
...
void compute_marker_analysis(tree_info *         trees,
                             tree_markers_info **markers,
                             hist_info *         M_hist,
                             hist_info *         xoff_hist,
                             hist_info *         SSFctn_hist,
...
int             fetch_treenode_n_particles_inclusive(tree_info *trees, tree_node_info *halo);
...
int             fetch_treenode_n_particles_inclusive_peak(tree_info *trees, tree_node_info *halo);
int             fetch_treenode_substructure_rank(tree_info *trees, tree_node_info *halo);
