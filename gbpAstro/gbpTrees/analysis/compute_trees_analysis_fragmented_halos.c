...
void compute_trees_analysis_fragmented_halos(tree_info *trees, char *filename_out_root_in, int i_type, double logM_min, double dlogM, int n_logM) {
    ...
    double *backmatch_score_norm;
    init_treenode_info_data(list_halos_new, SID_FARG backmatch_score_norm, SID_DOUBLE, "Backmatch f_goodness");
    double *backmatch_score;
    init_treenode_info_data(list_halos_new, SID_FARG backmatch_score, SID_DOUBLE, "Backmatch score");
    int *backmatch_type;
    init_treenode_info_data(list_halos_new, SID_FARG backmatch_type, SID_INT, "Backmatch tree case");
    int *backmatch_index;
    init_treenode_info_data(list_halos_new, SID_FARG backmatch_index, SID_INT, "Backmatch index");
    int *backmatch_snapshot;
    init_treenode_info_data(list_halos_new, SID_FARG backmatch_snapshot, SID_INT, "Backmatch snapshot");
    int *backmatch_n_p;
    init_treenode_info_data(list_halos_new, SID_FARG backmatch_n_p, SID_INT, "Backmatch n_particles");
    int *frag_length;
    init_treenode_info_data(list_halos_new, SID_FARG frag_length, SID_INT, "Fragment length (snapshots)");
    double *delta_frag_norm;
    init_treenode_info_data(list_halos_new, SID_FARG delta_frag_norm, SID_DOUBLE, "delta_fragmented/t_dyn(z)");
    double *delta_fragmented;
    init_treenode_info_data(list_halos_new, SID_FARG delta_fragmented, SID_DOUBLE, "delta_fragmented [Gyrs]");
    int *stop_index;
    init_treenode_info_data(list_halos_new, SID_FARG stop_index, SID_INT, "Fragment's stopping index");
    int *stop_snapshot;
    init_treenode_info_data(list_halos_new, SID_FARG stop_snapshot, SID_INT, "Fragment's stopping snapshot");
    int *start_index;
    init_treenode_info_data(list_halos_new, SID_FARG start_index, SID_INT, "Fragment's starting index");
    int *start_snapshot;
    init_treenode_info_data(list_halos_new, SID_FARG start_snapshot, SID_INT, "Fragment's starting snapshot");
    int *backmatch_id;
    init_treenode_info_data(list_halos_new, SID_FARG backmatch_id, SID_INT, "Backmatch id");
