    ...
    for(int i_snap = 0; i_snap < trees->n_snaps; i_snap++) {
        ...
        for(int i_halo = 0; i_halo < n_halos_total[i_snap]; i_halo++) {
            ...
            for(int i_marker = 0; i_marker < n_markers; i_marker++) {
                ...
                int halo_index;
                SID_fread_all_buffer(&halo_index, sizeof(int), 1, fp_in_buffer);
                if(flag_keep) {
                    ...
                    if(halo_index >= 0) {
                        ...
                        int marker_index;
                        int test[5];
                        marker_index = find_index_int(test, halo_index, (size_t)(n_halos_local[halo_snap]), file_index_local_index[halo_snap]);
