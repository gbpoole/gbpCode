...
void compute_trees_analysis_strayed_halos(tree_info *trees, char *filename_out_root_in, int i_type, double logM_min, double dlogM, int n_logM) {
    ...
    double *delta_normed;
    init_treenode_info_data(list_halos, SID_FARG delta_normed, SID_DOUBLE, "Strayed branch length/t_dyn(z)");
    double *delta_strayed;
    init_treenode_info_data(list_halos, SID_FARG delta_strayed, SID_DOUBLE, "Strayed branch length [Gyrs]");
    int *delta_snap;
    init_treenode_info_data(list_halos, SID_FARG delta_snap, SID_INT, "Strayed branch length (snapshots)");
