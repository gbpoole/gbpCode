                ...
                if(n_dropped_i == 0) {
                    ...
                    while(current_progenitor != NULL) {
                        ...
                        if(flag_dropped) {
                            ...
                            delta_normed[i_halos_dropped] =
                                fetch_treenode_delta_t(trees, current_progenitor->descendant, current_progenitor) / t_dyn_z(z, trees->cosmo);
                            delta_dropped[i_halos_dropped] =
                                fetch_treenode_delta_t(trees, current_progenitor->descendant, current_progenitor) / S_PER_GYR;
