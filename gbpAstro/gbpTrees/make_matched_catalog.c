        ...
        while(current != NULL) {
            ...
            if(current_properties->M_vir >= M_cut_min) {
                ...
                if(matched != NULL && flag_exact) {
                    ...
                    if(i_cat == 0)
                        fprintf(fp_out,
                                "%7d %7d %6d %5d %5d %10.3le %10.3le %10.3le %10.3le %10.3le %10.3le %10.3le %10.3le %10.3le %10.3le %10.3le %10.3le "
                        ...
                        fprintf(fp_out,
                                "%7d %7d %7d %7d %6d %10.3le %10.3le %10.3le %10.3le %10.3le %10.3le %10.3le %10.3le %10.3le %10.3le %10.3le %10.3le "
                                "%10.3le %10.3le %10.3le %10.3le\n",
