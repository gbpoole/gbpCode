...
void propagate_progenitor_info(int *        n_groups,
    ...
    int l_write         = l_read;
    int j_file          = 0;
    for(; j_write <= i_read_stop; i_read++, j_read += i_read_step, l_read--, j_file++) {
        ...
        if(j_read <= i_read_stop) {
            ...
            read_trees_horizontal((void **)groups_read,
                                  &n_groups_in,
                                  (void **)subgroups_read,
                                  &n_subgroups_in,
        ...
        if(j_file > n_search) {
            ...
            if(j_process <= i_read_stop) {
                ...
                propagate_merger_info(groups_read,
                                      n_groups,
                                      subgroups_read,
                                      n_subgroups,
                                      n_subgroups_group,
                ...
                if(flag_compute_fragmented) {
                    ...
                    propagate_fix_fragmented_info(groups_read,
                                                  n_groups,
                                                  subgroups_read,
                                                  n_subgroups,
                                                  n_subgroups_group,
                    ...
                    propagate_bridge_info(groups_read,
                                          n_groups,
                                          subgroups_read,
                                          n_subgroups,
                                          n_subgroups_group,
                    ...
                    propagate_fragmented_info(groups_read,
                                              n_groups,
                                              subgroups_read,
                                              n_subgroups,
                                              n_subgroups_group,
                ...
                propagate_dominant_substructures(groups_read,
                                                 n_groups,
                                                 subgroups_read,
                                                 n_subgroups,
                                                 n_subgroups_group,
                ...
                propagate_n_particles_peak(groups_read,
                                           n_groups,
                                           subgroups_read,
                                           n_subgroups,
                                           n_subgroups_group,
