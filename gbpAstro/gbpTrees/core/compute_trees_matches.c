...
void check_for_tree_matches_local(char *filename_root_out,
                                  int   i_read_start,
                                  int   i_read_stop,
                                  int   i_read,
                                  int   n_search_total,
                    ...
                    for(k_match = 0; k_match < 2; k_match++) {
                        ...
                        if(filename_root_out != NULL)
                            sprintf(filename_out,
                                    "%s/%sgroup_matches_%s_%s.dat",
                                    filename_out_dir_snap,
                                    group_text_prefix,
                                    filename_cat1_order,
                                    filename_cat2_order);
                        else
                            sprintf(filename_out,
                                    "%s_%sgroup_matches_%s_%s.dat",
                                    filename_out_name,
                                    group_text_prefix,
                                    filename_cat1_order,
                                    filename_cat2_order);
