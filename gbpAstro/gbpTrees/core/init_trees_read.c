...
void init_trees_read(const char *filename_SSimPL_dir,
    ...
    (*tree)->subgroup_backmatch_pointers = NULL;
    (*tree)->group_forematch_pointers    = NULL;
    (*tree)->subgroup_forematch_pointers = NULL;
    (*tree)->group_descendant_score      = NULL;
    (*tree)->subgroup_descendant_score   = NULL;
    (*tree)->group_progenitor_score      = NULL;
    (*tree)->subgroup_progenitor_score   = NULL;
    (*tree)->group_backmatch_score       = NULL;
    (*tree)->subgroup_backmatch_score    = NULL;
    (*tree)->group_forematch_score       = NULL;
    (*tree)->subgroup_forematch_score    = NULL;
