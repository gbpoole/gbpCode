    ...
    for(i_rank = 0; i_rank < SID.n_proc; i_rank++) {
        if(i_rank == SID.My_rank) {
            ...
            for(i = 0; i < n_gas; i++) {
                ...
                // x
                if(x_gas_flag)
                    dummy_f = (float)(x_gas[i] * h_Hubble / M_PER_MPC);
                else
                    dummy_f = 0.;
                fprintf(fp, " %11.4le", dummy_f);
                // y
                if(y_gas_flag)
                    dummy_f = (float)(y_gas[i] * h_Hubble / M_PER_MPC);
                else
                    dummy_f = 0.;
                fprintf(fp, " %11.4le", dummy_f);
                // z
                if(z_gas_flag)
                    dummy_f = (float)(z_gas[i] * h_Hubble / M_PER_MPC);
                else
                    dummy_f = 0.;
                fprintf(fp, " %11.4le", dummy_f);
                // vx
                if(vx_gas_flag)
                    dummy_f = (float)(vx_gas[i] / 1e3);
                else
                    dummy_f = 0.;
                fprintf(fp, " %11.4le", dummy_f);
                // vy
                if(vy_gas_flag)
                    dummy_f = (float)(vy_gas[i] / 1e3);
                else
                    dummy_f = 0.;
                fprintf(fp, " %11.4le", dummy_f);
                // vz
                if(vz_gas_flag)
                    dummy_f = (float)(vz_gas[i] / 1e3);
                else
                    dummy_f = 0.;
                /*
                    fprintf(fp," %11.4le",dummy_f);
            ...
            for(i = 0; i < n_dark; i++) {
                ...
                // x
                if(x_dark_flag)
                    dummy_f = (float)(x_dark[i] * h_Hubble / M_PER_MPC);
                else
                    dummy_f = 0.;
                // fprintf(fp," %11.4le,",dummy_f);
                ...
                // y
                if(y_dark_flag)
                    dummy_f = (float)(y_dark[i] * h_Hubble / M_PER_MPC);
                else
                    dummy_f = 0.;
                // fprintf(fp," %11.4le,",dummy_f);
                fprintf(fp, " %5.3lf,", dummy_f);
                // z
                if(z_dark_flag)
                    dummy_f = (float)(z_dark[i] * h_Hubble / M_PER_MPC);
                else
                    dummy_f = 0.;
                // fprintf(fp," %11.4le,",dummy_f);
                fprintf(fp, " %5.3lf,", dummy_f);
            ...
            for(i = 0; i < n_star; i++) {
                ...
                // x
                if(x_star_flag)
                    dummy_f = (float)(x_star[i] * h_Hubble / M_PER_MPC);
                else
                    dummy_f = 0.;
                fprintf(fp, " %11.4le", dummy_f);
                // y
                if(y_star_flag)
                    dummy_f = (float)(y_star[i] * h_Hubble / M_PER_MPC);
                else
                    dummy_f = 0.;
                fprintf(fp, " %11.4le", dummy_f);
                // z
                if(z_star_flag)
                    dummy_f = (float)(z_star[i] * h_Hubble / M_PER_MPC);
                else
                    dummy_f = 0.;
                fprintf(fp, " %11.4le", dummy_f);
                // vx
                if(vx_star_flag)
                    dummy_f = (float)(vx_star[i] / 1e3);
                else
                    dummy_f = 0.;
                fprintf(fp, " %11.4le", dummy_f);
                // vy
                if(vy_star_flag)
                    dummy_f = (float)(vy_star[i] / 1e3);
                else
                    dummy_f = 0.;
                fprintf(fp, " %11.4le", dummy_f);
                // vz
                if(vz_star_flag)
                    dummy_f = (float)(vz_star[i] / 1e3);
                else
                    dummy_f = 0.;
                fprintf(fp, " %11.4le", dummy_f);
                /*
