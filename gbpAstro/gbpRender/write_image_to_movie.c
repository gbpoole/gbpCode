...
static void fill_yuv_image(AVFrame *picture, image_info *image, AVCodecContext *c) {
    ...
    img_convert_ctx = sws_getContext(c->width, c->height, PIX_FMT_RGBA32, c->width, c->height, c->pix_fmt, GBPGFX_SWS_FLAGS, NULL, NULL, NULL);
    sws_scale(img_convert_ctx, tmp_frame->data, tmp_frame->linesize, 0, c->height, picture->data, picture->linesize);
}
#endif
