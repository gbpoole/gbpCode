...
int main(int argc, char *argv[]) {
    ...
    if(SID.I_am_Master) {
        ...
        // Read from catalog
        SID_log("Reading halo...", SID_LOG_OPEN);
        fp_catalog_info fp_group_properties;
        if(flag_process_group)
            fopen_catalog(filename_root, snap_number, READ_CATALOG_GROUPS | READ_CATALOG_PROPERTIES | READ_CATALOG_PROFILES, &fp_group_properties);
        else
            fopen_catalog(filename_root, snap_number, READ_CATALOG_SUBGROUPS | READ_CATALOG_PROPERTIES | READ_CATALOG_PROFILES, &fp_group_properties);
        ...
        lambda = sqrt(properties.spin[0] * properties.spin[0] + properties.spin[1] * properties.spin[1] + properties.spin[2] * properties.spin[2]) /
                 (sqrt(2.) * properties.R_vir * v_c);
        offset_COM =
            sqrt(pow(properties.position_COM[0] - properties.position_MBP[0], 2.) + pow(properties.position_COM[1] - properties.position_MBP[1], 2.) +
                 pow(properties.position_COM[2] - properties.position_MBP[2], 2.));
        ...
        SID_log("   position_COM=%14.6e %14.6e %14.6e [Mpc/h]",
                SID_LOG_COMMENT,
                properties.position_COM[0],
                properties.position_COM[1],
                properties.position_COM[2]);
        SID_log("   position_MBP=%14.6e %14.6e %14.6e [Mpc/h]",
                SID_LOG_COMMENT,
                properties.position_MBP[0],
                properties.position_MBP[1],
                properties.position_MBP[2]);
        SID_log("   velocity_COM=%14.6e %14.6e %14.6e [km/s]",
                SID_LOG_COMMENT,
                properties.velocity_COM[0],
                properties.velocity_COM[1],
                properties.velocity_COM[2]);
        SID_log("   velocity_MBP=%14.6e %14.6e %14.6e [km/s]",
                SID_LOG_COMMENT,
                properties.velocity_MBP[0],
                properties.velocity_MBP[1],
                properties.velocity_MBP[2]);
        ...
        fprintf(fp_out, "# Analysis of %sgroup #%d in snap #%d of %s\n", prefix_text, i_group_selected, snap_number, filename_root);
        fprintf(fp_out, "#   id_MBP      =%14lld\n", properties.id_MBP);
        fprintf(fp_out, "#   n_particles =%14d\n", properties.n_particles);
        fprintf(fp_out,
                "#   position_COM=%14.6e %14.6e %14.6e [Mpc/h]\n",
                properties.position_COM[0],
                properties.position_COM[1],
                properties.position_COM[2]);
        fprintf(fp_out,
                "#   position_MBP=%14.6e %14.6e %14.6e [Mpc/h]\n",
                properties.position_MBP[0],
                properties.position_MBP[1],
                properties.position_MBP[2]);
        fprintf(fp_out,
                "#   velocity_COM=%14.6e %14.6e %14.6e [km/s]\n",
                properties.velocity_COM[0],
                properties.velocity_COM[1],
                properties.velocity_COM[2]);
        fprintf(fp_out,
                "#   velocity_MBP=%14.6e %14.6e %14.6e [km/s]\n",
                properties.velocity_MBP[0],
                properties.velocity_MBP[1],
                properties.velocity_MBP[2]);
        ...
        for(i_profile = 0, r_max = 0.; i_profile < profile.n_bins; i_profile++) {
            ...
            lambda = sqrt(profile.bins[i_profile].spin[0] * profile.bins[i_profile].spin[0] +
                          profile.bins[i_profile].spin[1] * profile.bins[i_profile].spin[1] +
                          profile.bins[i_profile].spin[2] * profile.bins[i_profile].spin[2]) /
                     (sqrt(2.) * v_c * profile.bins[i_profile].r_max);
            offset_COM = sqrt(pow(profile.bins[i_profile].position_COM[0], 2.) + pow(profile.bins[i_profile].position_COM[1], 2.) +
                              pow(profile.bins[i_profile].position_COM[2], 2.));
            fprintf(fp_out,
                    "%e %e %e %9d %e %e %e %e %e %e %le %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e\n",
                    r_min,
                    ...
                    profile.bins[i_profile].spin[0],
                    profile.bins[i_profile].spin[1],
                    profile.bins[i_profile].spin[2],
                    lambda,
