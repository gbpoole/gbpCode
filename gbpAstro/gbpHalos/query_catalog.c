...
int main(int argc, char *argv[]) {
    ...
    if(SID.I_am_Master) {
        ...
        if(flag_process_group)
            fopen_catalog(filename_root, snap_number, READ_CATALOG_GROUPS | READ_CATALOG_PROPERTIES, &fp_group_properties);
        else
            fopen_catalog(filename_root, snap_number, READ_CATALOG_SUBGROUPS | READ_CATALOG_PROPERTIES, &fp_group_properties);
