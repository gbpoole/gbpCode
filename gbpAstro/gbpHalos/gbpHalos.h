...
void read_groups_AHF(char *filename_groups_root, int i_file, int mode, plist_info *plist, char *catalog_name);
...
int  fread_catalog_file(fp_catalog_info *           fp_in,
                        halo_properties_SHORT_info *properties_short_out,
                        halo_properties_SAGE_info * properties_out,
                        halo_properties_info *      properties_all_out,
                        halo_profile_info *         profiles_out,
                        int                         halo_index);
