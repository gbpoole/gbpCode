...
void   apply_rotation(double x_hat, double y_hat, double z_hat, double theta, double *x_i, double *y_i, double *z_i);
...
void   init_array_linear(double val_min, double val_max, int n_val, double **val, double *step);
void   init_array_log(double val_min, double val_max, int n_val, double **val);
#ifdef __cplusplus
}
#endif
#endif
