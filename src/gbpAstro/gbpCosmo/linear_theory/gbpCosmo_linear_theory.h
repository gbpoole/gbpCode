...
void   pspec_names(int mode, int component, char *mode_name, char *component_name);
...
double merger_rate_B_n(cosmo_info **cosmo, int mode, double z, double M_0, double zeta);
double power_spectrum_normalization(cosmo_info *cosmo, int mode, int component);
double power_spectrum_variance(double k_interp, double redshift, cosmo_info **cosmo, int mode, int component);
double dln_Inv_sigma_dlogM(cosmo_info **cosmo, double M_interp, int mode, int component);
void   init_sigma_M(cosmo_info **cosmo, int mode, int component);
double sigma_M(cosmo_info **cosmo, double M_interp, double z, int mode, int component);
double sigma_R(cosmo_info **cosmo, double R, double z, int mode, int component);
double ln_sigma_M(cosmo_info **cosmo, double M_interp, double z, int mode, int component);
double ln_Inv_sigma_M(cosmo_info **cosmo, double M_interp, double z, int mode, int component);
double dln_sigma_dlnM(cosmo_info **cosmo, double M_interp, double z, int mode, int component);
...
double linear_growth_factor(double redshift, cosmo_info **cosmo);
double sigma2_integrand(double k, void *params_in);
double W_k_tophat(double kR);
double M_sc(double z, cosmo_info **cosmo, int mode, int component);
double lk_sc(double z, cosmo_info **cosmo, int mode, int component);
#ifdef __cplusplus
}
#endif
#endif
