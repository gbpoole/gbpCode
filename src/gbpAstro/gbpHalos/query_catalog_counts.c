...
int main(int argc, char *argv[]) {
    ...
    if(SID.I_am_Master) {
        ...
        for(int i_snap = 0; i_snap < n_snaps; i_snap++) {
            ...
            fopen_catalog(filename_group_properties, i_snap, READ_CATALOG_GROUPS | READ_CATALOG_PROPERTIES, &fp_group_properties);
            fopen_catalog(filename_subgroup_properties, i_snap, READ_CATALOG_SUBGROUPS | READ_CATALOG_PROPERTIES, &fp_subgroup_properties);
            ...
            fprintf(fp_out,
                    ...
                    i_snap,
                    a_list[i_snap],
                    z_of_a(a_list[i_snap]),
                    fp_group_properties.n_halos_total,
                    fp_subgroup_properties.n_halos_total);
