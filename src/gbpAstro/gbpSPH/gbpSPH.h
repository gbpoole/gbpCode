...
void process_gadget_file(const char *status_message,
                         ...
                         int *       flag_long_IDs,
                         int         mode);
void allocate_gadget_particles(plist_info *plist, size_t *n_particles_type_local, size_t *n_particles_type, int flag_long_IDs);
...
int  select_gadget_all(gadget_read_info *fp_gadget,
                       ...
                       GBPREAL *         vel,
                       size_t            ID_i);
void open_gadget_file(char *filename_root_in, int snapshot_number, fp_gadget *fp);
...
void   change_gadget_filename(const char *filename_root_in,
...
void   translate_sph(plist_info *plist, double x_cen, double y_cen, double z_cen, double vx_cen, double vy_cen, double vz_cen);
void   fetch_particles(plist_info *plist, char *var_text, char *ptype_in_text, char *mark_name, void **rval, size_t *n_rval);
size_t mark_particles(plist_info *plist, int run_mode, double *input_vars, const char *mark_name);
void   compute_particle_quantity(plist_info *plist, char *var_text, char *ptype_in_text);
void   read_mark_file(plist_info *plist, const char *mark_name, const char *filename_in, int mode);
void   read_tipsy_mark_file(char *filename, plist_info *plist, char *mark_name);
void   read_tipsy_binary(char *filename, plist_info *plist);
void   read_tipsy_ascii(char *filename, plist_info *plist);
void   write_gadget_binary_new(plist_info *plist, char *filename_out_root, int n_files, int mode);
void   write_tipsy_binary(char *filename, plist_info *plist);
void   write_gadget_ascii(char *filename, plist_info *plist, size_t *id_ordering);
void   write_gadget_csv(char *filename_out, plist_info *plist);
void   write_gadget_bin(char *filename_out, plist_info *plist);
void   write_mark_file(plist_info *plist, const char *mark_name, const char *filename_out);
void   read_tipsy_ids(char *filename, plist_info *plist);
void   read_smooth(plist_info *plist, char *filename_root, int snapshot_number, int mode);
...
void   make_map(plist_info *plist,
                ...
                int         mode,
                char *      parameter);
void   write_smooth(plist_info *plist, char *species_name, char *filename, int n_chunks, int mode);
void   prep_types(char ***pname, int n_type, ...);
void   read_gadget_binary_header(char *filename_root_in, int snapshot_number, plist_info *plist);
void   read_gadget_binary(char *filename_root_in, int snapshot_number, plist_info *plist, int mode);
void   write_gadget_binary(char *filename, plist_info *plist);
...
void assign_particles_to_grid(plist_info *plist, double *L, int *n, char *species_name);
void smooth_grid(plist_info *plist, int grid_size, char *species_name, int mode);
#ifdef __cplusplus
}
#endif
#endif
