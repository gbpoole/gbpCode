...
int check_if_descendant_is_back_matched(tree_horizontal_info *halo, tree_horizontal_info *descendant) {
    // int flag_is_back_matched=GBP_FALSE;
    // if(descendant!=NULL){
    ...
    //      if((back_matches[i_back_match].halo)==halo) flag_is_back_matched=GBP_TRUE;
    //   }
    //}
