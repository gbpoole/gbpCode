...
void assign_progenitor_order_vertical_recursive(tree_vertical_node_info *tree, int *M_i, int mode) {
    tree_vertical_node_info * first_new;
    tree_vertical_node_info * last_new;
    tree_vertical_node_info * current;
    tree_vertical_node_info **progenitors;
    int                       i_progenitor;
    size_t *                  M_iN_index;
    size_t *                  M_iN_rank;
    ...
    if(tree->n_progenitors >= 1) {
        ...
        progenitors  = (tree_vertical_node_info **)SID_malloc(sizeof(tree_vertical_node_info *) * tree->n_progenitors);
        i_progenitor = 0;
