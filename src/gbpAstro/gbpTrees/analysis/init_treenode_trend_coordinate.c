...
void init_treenode_trend_coordinate(tree_info *trees, trend_info *trend, const char *name) {
    if(!strcmp(name, "z"))
        ...
        init_trend_coordinate(trend, name, trees, init_tree_property_Vir_ratio, free_tree_property_Vir_ratio, calc_tree_property_index_Vir_ratio);
    else if(!strcmp(name, "log_sigma_vx"))
        init_trend_coordinate(
            trend, name, trees, init_tree_property_log_sigma_vx, free_tree_property_log_sigma_vx, calc_tree_property_index_log_sigma_vx);
