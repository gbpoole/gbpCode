...
#define PARAMETER_MODE_OPTIONAL SID_TTTP01
#define PARAMETER_MODE_MANDITORY SID_TTTP02
#define PARAMETER_MODE_UNIQUE SID_TTTP03
...
void init_parameter_item(parameter_item_info **param_item, const char *name, SID_Datatype data_type, int mode);
void free_parameter_item(parameter_item_info **param_item);
void free_parameter_list(parameter_list_info **param_list);
void add_parameter_to_list(parameter_list_info *param_list, const char *name, SID_Datatype data_type, int mode);
...
void read_gbpParam_file(const char *filename_in, parameter_list_info *param_list);
#ifdef __cplusplus
}
#endif
