...
list(APPEND INCFILES "gbpFITS.h")

# Add source files
# eg. list(APPEND SRCFILES "filename.ext")
list(APPEND SRCFILES "transpose_array.c" )
list(APPEND SRCFILES "read_image_FITS.c" )
list(APPEND SRCFILES "write_image_FITS.c" )
list(APPEND SRCFILES "append_image_FITS.c" )
