...
list(APPEND INCFILES "gbpCosmo_mass_functions.h" )

# Add source files
# eg. list(APPEND SRCFILES "file" )
list(APPEND SRCFILES "mass_function.c" )
list(APPEND SRCFILES "mass_function_cumulative.c" )
list(APPEND SRCFILES "scaled_mass_function.c" )
